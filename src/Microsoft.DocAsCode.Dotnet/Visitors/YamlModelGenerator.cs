...
internal class YamlModelGenerator
{
    ...
    public YamlModelGenerator(Compilation compilation, HashSet<IAssemblySymbol> allAssemblies)
    {
    ...
    public void GenerateReference(ISymbol symbol, ReferenceItem reference, bool asOverload)
    {
        ...
        reference.NameParts[SyntaxLanguage.CSharp] = SymbolFormatter.GetNameParts(symbol, SyntaxLanguage.CSharp, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.CSharp, asOverload);
        reference.NameWithTypeParts[SyntaxLanguage.CSharp] = SymbolFormatter.GetNameWithTypeParts(symbol, SyntaxLanguage.CSharp, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.CSharp, asOverload);
        reference.QualifiedNameParts[SyntaxLanguage.CSharp] = SymbolFormatter.GetQualifiedNameParts(symbol, SyntaxLanguage.CSharp, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.CSharp, asOverload);
        ...
        reference.NameParts[SyntaxLanguage.VB] = SymbolFormatter.GetNameParts(symbol, SyntaxLanguage.VB, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.VB, asOverload);
        reference.NameWithTypeParts[SyntaxLanguage.VB] = SymbolFormatter.GetNameWithTypeParts(symbol, SyntaxLanguage.VB, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.VB, asOverload);
        reference.QualifiedNameParts[SyntaxLanguage.VB] = SymbolFormatter.GetQualifiedNameParts(symbol, SyntaxLanguage.VB, nullableReferenceType: false, asOverload).ToLinkItems(_compilation, _allAssemblies, SyntaxLanguage.VB, asOverload);
    }
