...
internal static class SymbolHelper
{
    ...
    {
        config ??= new();
        return assembly.Accept(new SymbolVisitorAdapter(compilation, new(compilation, new(new[] { assembly }, SymbolEqualityComparer.Default)), config, new(config, options ?? new()), extensionMethods));
    }
