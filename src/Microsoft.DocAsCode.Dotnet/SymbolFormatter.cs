...
internal static partial class SymbolFormatter
{
    ...
    public static List<LinkItem> ToLinkItems(this ImmutableArray<SymbolDisplayPart> parts, Compilation compilation, HashSet<IAssemblySymbol> allAssemblies, SyntaxLanguage language, bool overload)
    {
        ...
        LinkItem ToLinkItem(SymbolDisplayPart part)
        {
            ...
            return new()
            {
                ...
                Href = SymbolUrlResolver.GetSymbolUrl(symbol, compilation, allAssemblies),
